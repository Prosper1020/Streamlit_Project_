...
if page == pages[3]:
    ...
    df=df_or .drop('Mass in running order (kg)', axis=1)
    del df_or
    ...
    if task_type == 'Regression':
        ...
        if features and target:
            ...
            coefficients = pd.DataFrame(lasso_r.coef_, index=features, columns=['Coefficient'])
            ...
            ax.set_title('Feature Coefficients in the Lasso Regression Model')
